      ...
      <div className="mx-auto max-w-[1440px] px-6 md:px-12 lg:px-20 py-12">
        ...
        <div className="flex flex-col items-center md:flex-row md:items-center md:justify-between gap-6 md:gap-8 mb-16">
          ...
          <div className="flex items-center gap-5 order-3 md:order-2">
            {/* X / Twitter */}
            <a href="https://x.com/DocTFrost" target="_blank" rel="noopener noreferrer" className="text-[#CDC6B3] hover:text-[#D2B06B] transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            {/* LinkedIn */}
            <a href="https://linkedin.com/in/timfrostpharmd" target="_blank" rel="noopener noreferrer" className="text-[#CDC6B3] hover:text-[#D2B06B] transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
